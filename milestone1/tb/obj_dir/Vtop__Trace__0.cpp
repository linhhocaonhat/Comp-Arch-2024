...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+2,(vlSelf->i_nickel));
    ...
    bufp->chgCData(oldp+7,(vlSelf->top__DOT__vending__DOT__current_state),4);
    bufp->chgCData(oldp+8,(vlSelf->top__DOT__vending__DOT__next_state),4);
}
